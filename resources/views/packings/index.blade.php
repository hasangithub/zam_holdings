...
@section('title','Shipment Packings')
...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <h4 class="mb-0">
                <i class="fas fa-truck mr-1"></i> Shipment Packings
            </h4>
        </div>
    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table id="shipmentTable" class="table table-bordered table-striped table-sm table-erp">
                    ...
                    <tbody>
                        ...
                        @forelse($shipmentPlans as $plan)
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong>{{ $plan->packing_no ?? 'SW-'.$plan->id }}</strong>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('packings.show', $plan->id) }}"
